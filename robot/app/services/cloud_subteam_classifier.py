...
from app.routing.team_router import decide_cloud_subteam
...
def predict_cloud_subteam_by_ml(info, clean_body, subject, to_address):
    ...
    try:
        ...
        if hasattr(ML_MODEL, "predict_proba"):
            ...
            print(f"🤖 ML predicted: {predicted_label} | confidence={confidence:.4f} ({confidence*100:.2f}%) | subject: {subject}")
        else:
            print(f"🤖 ML predicted: {predicted_label} | confidence=N/A (no predict_proba) | subject: {subject}")
